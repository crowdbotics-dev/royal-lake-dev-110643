"""
Django settings for royal_lake_dev_110643 project.
...
ROOT_URLCONF = 'royal_lake_dev_110643.urls'
...
WSGI_APPLICATION = 'royal_lake_dev_110643.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_lake_dev_110643 API",
    "DESCRIPTION": "API documentation for royal_lake_dev_110643 App",
    "VERSION": "v1",
}
